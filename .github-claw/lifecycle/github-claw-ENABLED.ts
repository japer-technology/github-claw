/**
 * github-claw-ENABLED.ts — Fail-closed guard for the github-claw-ENABLED.md sentinel file.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * PURPOSE
 * ─────────────────────────────────────────────────────────────────────────────
 * This script is the very first step executed in every github-claw-* workflow.
 ...
 *
 *   - name: Guard
 *     run: bun .github-claw/lifecycle/github-claw-ENABLED.ts
 *
 * To ENABLE  GitClaw: ensure `.github-claw/github-claw-ENABLED.md` exists in the repo.
 * To DISABLE GitClaw: delete `.github-claw/github-claw-ENABLED.md` and commit the removal.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * DEPENDENCIES
 * ─────────────────────────────────────────────────────────────────────────────
...
// `.github-claw/lifecycle/`.  We step one level up (`..`) to reach `.github-claw/`,
// then join with the sentinel filename.
const enabledFile = resolve(import.meta.dir, "..", "github-claw-ENABLED.md");
...
console.log("GitClaw enabled — github-claw-ENABLED.md found.");
